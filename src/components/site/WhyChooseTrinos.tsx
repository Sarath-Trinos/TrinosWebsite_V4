        ...
        <div className="relative mt-20 sm:mt-24">
          ...
          <div className="pointer-events-none absolute inset-x-0 z-10 hidden lg:block" style={{ top: "1.75rem" }}>
            <div className="relative mx-auto" style={{ width: "75%", height: "2px" }}>
              ...
              <div
                className={cn(
                  "absolute inset-y-0 left-0 origin-left rounded-full bg-gradient-to-r from-primary via-primary-glow to-primary-deep transition-transform duration-[1400ms] ease-out",
              ...
              {[1, 3, 5].map((n) => (
                <span
                  ...
                  style={{ left: `${(n / 6) * 100}%`, top: "50%" }}
                >
                  <span className="block h-2.5 w-2.5 rounded-full bg-primary shadow-[0_0_0_4px_hsl(var(--primary)/0.12)]" />
                </span>
              ))}
            </div>
          </div>
